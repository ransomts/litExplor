  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      tabsetPanel(type = "tabs",
                  tabPanel("Compare", tableOutput("compare")),
...
server <- function(input, output) {
  ...
  # defined below then use the value computed from this expression
    ...
    calculate_somthing <- function(str){
      print(test)
      test <<- test + 1
      return(paste(str, "s"))
    }
  ...
  observeEvent(input$search, {
    ...
    # Render a copy of terms because if we don't this function is called every time the terms are changed
  ...
  num_found <- mapply(function(x) { return(x$response$numFound) }, eric_responses)
    ...
    output$compare <- renderTable(num_found)
