...
display_button_event <- eventReactive(input$display_button, {
  ...
  found_kable <- knitr::kable(num_found, align = 'c', col.names = c("Number Found"), label = "ERIC Results", caption = "Number of results found")
  
  return(paste(found_kable, collapse = '\n'))
})
