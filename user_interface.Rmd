...
format_terms_input2 <- function(search_terms) {
...
display_button_event <- eventReactive(input$display_button, {
  ...
  # Currently cartesian returns a list of strings. 
  # That means that instead of searching for "FOO AND BAR" we're searching for "FOO  BAR"
  # It should be fine for now as this simply serves to prove that we can search the database with our user input. 
  # Also it will be fixed once we create our own cartesian product function.
  ...
  return(paste(cartesian_product_of_terms, eric_responses, sep = "\n", collapse = '\n\n'))
})
